...
const GetNewFactHandler = {
  canHandle(handlerInput) {
    ...
    return (
      ...
      (request.type === 'IntentRequest' && request.intent.name === 'GetFact')
    );
  },
  handle(handlerInput) {
...
const FallbackHandler = {
  ...
  handle(handlerInput) {
    return handlerInput.responseBuilder
      .speak(
        'I\'m sorry but Developer Dog doesn\'t understand that request. You can say tell me a fact, or, you can say exit...'
      )
      .reprompt('What can I help you with?')
      .getResponse();
  }
